...
export const paramType = {
	...
	'reportdpzb': "/bireport/getDPZB", // 蛋鸡占比
	'reporttzsw': "/bireport/getTZSW", //体重饲喂
	'reportll': "/bireport/getLL", //领料
	'reportchl': "/bireport/getCHL", //成活率
	'reportrk': "/bireport/getRK", //成活率
	'reportym': "/bireport/getYM", //成活率
	'reportwdsd': "/bireport/getWDSD",
	'getMp4Url': "/bireport/getMp4Url",
	'reportCPL': "/bireport/getCPL",
	'reportJDXX': "/bireport/getJDXX",
	'reportSales': "/bireport/getJDXX",
	'reportSALDZZB': "/bireport/getSALDZZB",
}
/******************      通用增删改查       ********************* */
/**
 * 通用列表
